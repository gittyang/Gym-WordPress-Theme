...
// --- This page shows the sidebar classes ---
 ...
 */
class Gym_Classes_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
      'gym_classes', // Base ID
			esc_html__( 'Gym - Classes List', 'text_domain' ), // Name
    ...
    <ul class="sidebar-classes-list">
      <?php 
        $args = array(
          // Obtain info from gymfitness_classes in gym_post_types.php
...
function gym_classes_widget() {
  register_widget( 'Gym_Classes_Widget' );
}
add_action( 'widgets_init', 'gym_classes_widget' );
